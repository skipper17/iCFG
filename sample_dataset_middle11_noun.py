...
def main(args):
    #path decision
    path = "/home/data/iclr24out/middle11_noun_guidance_scale_" + str(args.guidance_scale) + "_alpha_" + str(args.alpha) + "_steps_" + str(args.num_inference_steps) + "_" + str(time.time())[0:10]
    os.mkdir(path)
    ...
    for id in tqdm(range(1250)):
        ...
        for pos in noun_tuples:
            middle_embeddings[pos] = middle_embeddings[pos] * MIDDLE_POS + uncond_embeddings[pos] * (1 - MIDDLE_POS)
