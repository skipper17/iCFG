...
def main(args):
    #path decision
    path = "/home/data/iclr24out/middle105_all_guidance_scale_" + str(args.guidance_scale) + "_alpha_" + str(args.alpha) + "_" + str(time.time())[0:10]
    os.mkdir(path)
    ...
    for id in tqdm(range(1250)):
        ...
        middle_embeddings = uncond_embeddings  * (1 - MIDDLE_POS) + text_embeddings * MIDDLE_POS
